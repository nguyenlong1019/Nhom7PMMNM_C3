...
class App:
    ...
    def export_word(self):
        ...
        # Định dạng tiêu đề
        title = doc.add_paragraph("Báo cáo học phần")
        title.runs[0].bold = True
        title.runs[0].font_size = Pt(18)
        title.alignment = WD_ALIGN_PARAGRAPH.CENTER

        # Định dạng căn trái
        left_aligned = doc.add_paragraph("Đây là đoạn căn trái")
        left_aligned.alignment = WD_ALIGN_PARAGRAPH.LEFT

        # Định dạng căn phải
        right_aligned = doc.add_paragraph("Đây là đoạn căn phải")
        right_aligned.alignment = WD_ALIGN_PARAGRAPH.RIGHT

        # Định dạng căn giữa
        center_aligned = doc.add_paragraph("Đây là đoạn căn giữa")
        center_aligned.alignment = WD_ALIGN_PARAGRAPH.CENTER

        # Định dạng font chữ, font family, font weight
        formatted_text = doc.add_paragraph("Đoạn văn font Times New Roman, kích thước 14, không đậm")
        formatted_text.runs[0].font.name = "Times New Roman"
        formatted_text.runs[0].font.size = Pt(14)
        formatted_text.runs[0].bold = False
